...
sort_desa1 = datakk.sort_values(by=['tahun', 'namakab', 'namakec','luas_desa', 'namadesa'], ascending=[False,False,True,True,False])
...
with st.container(border=True):
    st.info(f"Desa {sort_desa1.iloc[20,2]} adalah desa terluas di Kecamatan {pilihkec}, {pilihkab} Tahun {pilihtahun} (Km2)")
